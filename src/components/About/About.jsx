...
export default function About() {
    return (
        <div className='aboutContainer'>
            <img src='images/laptopWave.png' alt="Avatar waving" className='laptopWaveImage' />
            <div className='textContainer'>
                ...
                Join me as we navigate the ever-evolving landscape of technology, innovation, and the beautiful journey of personal development.</p>
            </div>
        </div>
    );
}
